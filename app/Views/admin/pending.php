...
<div class="container-fluid">
    <h2 class="text-dark fw-bold mb-4">Pendaftaran Pending</h2>
    <?php
    $i = 1;
    ?>
        ...
        <table class="myTable table table-striped table-bordered">
            <thead>
                <tr>
                    ...
                    <th class="center-content">No Registrasi</th>
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <?php if ($p['status'] == 1) : ?>
                                            <h5 class="d-inline"> <span class="badge text-bg-success">ACC</span></h5>
                                        <?php endif; ?>
                                        <p class="card-text m-0" style="font-size: 1.05em;">Nomor Registrasi: <?= $p['no_registrasi']; ?></p>
